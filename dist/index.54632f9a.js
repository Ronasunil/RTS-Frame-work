...
const userCollection = (0, _user.User).buildCollection();
...
},{"./model/User":"eQi30","./views/UserForm":"gXSLD"}],"eQi30":[function(require,module,exports) {
...
class User extends (0, _model.Model) {
    static buildUser(userData) {
        const user = new User(new (0, _event.Event)(), new (0, _sync.Sync)("http://localhost:3000/users"), new (0, _attribute.Attribute)(userData));
        return user;
    }
...
},{"./Attribute":"ahwJM","./Model":"gFIRl","./Sync":"i0ODQ","./Event":"1sxOL","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./Collection":"1etZn"}],"ahwJM":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{}],"gFIRl":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Model", ()=>Model);
class Model {
    constructor(event, sync, attribute){
        this.event = event;
        this.sync = sync;
...
class Sync {
    constructor(rootUrl){
        ...
        this.fetch = (id, fn)=>{
            (0, _axiosDefault.default).get(`${this.rootUrl}/${id}`).then((res)=>{
                fn(res);
            });
        };
    }
    save(data) {
        const { id } = data;
        if (id) (0, _axiosDefault.default).put(`${this.rootUrl}/${id}`, data);
        else {
            console.log(this.rootUrl);
            (0, _axiosDefault.default).post(`${this.rootUrl}`, data);
        }
    }
}
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1sxOL":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Event", ()=>Event);
class Event {
    on(event, callback) {
        const handlers = this.event[event] || [];
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1etZn":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class Collection {
    constructor(url){
        this.url = url;
        this.collection = [];
        this.event = new (0, _event.Event)();
    }
    async getAllData() {
        return (0, _axiosDefault.default).get(this.url).then((res)=>{
    ...
    save(data) {
        ...
        (0, _axiosDefault.default).post(`${this.url}/users`, data).then((res)=>{
            this.event.on("save", ()=>console.log("data has been saved"));
        });
    }
}

},{"axios":"jo6P5","./Event":"1sxOL","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gXSLD":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "UserForm", ()=>UserForm);
var _userAge = require("./UserAge");
...
class UserForm extends (0, _view.View) {
    ...
    markup() {
        const userAgeView = new (0, _userAge.UserAge)(this.parentEl, this.data);
    ...
    addRender() {
        const userAgeContainer = this.parentEl.querySelector(".user-age");
        if (userAgeContainer) {
            const userAgeView = new (0, _userAge.UserAge)(userAgeContainer, this.data);
            userAgeView.render();
        }
    }
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./View":"5Vo78","./UserAge":"d7T48"}],"5Vo78":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"d7T48":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "UserAge", ()=>UserAge);
var _view = require("./View");
class UserAge extends (0, _view.View) {
    eventBind() {
        return {
            "click:.random-age-btn": this.generateRandomAge
        };
    }
    markup() {
        return `<span>age ${this.data.get("age")}</span>
                <button class="random-age-btn">Generate age</button>`;
    }
    constructor(...args){
        super(...args);
        this.generateRandomAge = ()=>{
            this.data.getRandomAge();
        };
    }
}

},{"./View":"5Vo78","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["5Rpdr","gg0zR"], "gg0zR", "parcelRequirea763")
